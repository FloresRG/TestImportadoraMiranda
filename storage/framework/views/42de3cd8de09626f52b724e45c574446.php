...
$.ajax({
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            var table = $('#envios-table').DataTable({
                ...
                stateSave: true,
                ajax: {
                    url: "<?php echo e(route('envios.dataTableSoloLaPaz')); ?>",
                    data: function(d) {
  ...
  render: function(data, type, row) {
    ...
    `;
                            ...
                            buttonHTML += `
    ${row.id_pedido ? 
        `<a href="/orden/cuaderno/sololapaz/edit/${row.id}/${row.id_pedido}" class="btn btn-light btn-sm" style="color: #007bff; border-color: #007bff; background-color: #f0f8ff;">
...
<?php echo $__env->make('adminlte::page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u919984931/domains/importadoramiranda.com/resources/views/envioscuaderno/indexlsoloapaz.blade.php ENDPATH**/ ?>