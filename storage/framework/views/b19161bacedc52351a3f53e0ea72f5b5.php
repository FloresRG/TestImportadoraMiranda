...
<?php $__env->startSection('content'); ?>
    <div class="mb-3 text-right">
        <a href="<?php echo e(route('caja_sucursal.create')); ?>" class="btn btn-gradient-primary btn-lg">
    ...
    <div class="mb-3 text-right">
        <a href="<?php echo e(route('reporte_caja_pdf', ['fecha_inicio' => request('fecha_inicio'), 'fecha_fin' => request('fecha_fin')])); ?>"
    ...
    <script>
        $(document).ready(function() {
            ...
            var table = $('#cajaSucursalesTable').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: '<?php echo e(url(route('caja_sucursal.index'))); ?>',
                    data: function(d) {
...
<?php echo $__env->make('adminlte::page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u919984931/domains/importadoramiranda.com/resources/views/caja_sucursal/index.blade.php ENDPATH**/ ?>