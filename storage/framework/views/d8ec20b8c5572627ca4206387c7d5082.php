...
<?php $__env->startSection('content'); ?>
    ...
    <div class="container mt-4">
        <div class="card">
            ...
            <div class="card-body">
                <form action="<?php echo e(route('orden.update', $pedido->id)); ?>" method="POST" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="row mt-3">
                        <div class="col-md-6">
                            ...
                            <select name="garantia" id="garantia" class="form-select <?php $__errorArgs = ['garantia'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>">
                                ...
                                <option value="sin garantia" <?php echo e(old('garantia', $pedido->garantia) == 'sin garantia' ? 'selected' : ''); ?>>Sin garantía</option>
                                <option value="con garantia" <?php echo e(old('garantia', $pedido->garantia) == 'con garantia' ? 'selected' : ''); ?>>Con garantía</option>
                            </select>
        ...
        <input type="number" step="0.01" name="transferencia_qr" id="transferencia_qr" class="form-control"
            value="<?php echo e(old('transferencia_qr', $pedido->transferencia_qr ?? 0)); ?>">
                    ...
                    <button type="submit" class="btn btn-primary" id="submitButton"><i class="fas fa-save"></i>
                        Guardar</button>
                    <a href="<?php echo e(route('orden.pedidos', $pedido->id_semana)); ?>" class="btn btn-secondary"><i
...
<?php echo $__env->make('adminlte::page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u919984931/domains/importadoramiranda.com/resources/views/orden/edit.blade.php ENDPATH**/ ?>