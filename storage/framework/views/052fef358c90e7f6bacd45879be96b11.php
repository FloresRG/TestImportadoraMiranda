...
<head>
    ...
    <link rel="icon" href="<?php echo e(asset('assets/imgs/main4.png')); ?>" type="image/x-icon">
   <!-- Font Icons -->
    <link rel="stylesheet" href="<?php echo e(asset('assets/vendors/themify-icons/css/themify-icons.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('assets/vendors/animate/animate.css')); ?>">
...
<!-- Bootstrap + FoodHut main styles -->
    <link rel="stylesheet" href="<?php echo e(asset('assets/css/foodhut.css')); ?>">
...
<body data-spy="scroll" data-target=".navbar" data-offset="40" id="home">
   ...
   <nav class="custom-navbar navbar navbar-expand-lg navbar-dark fixed-top" id="navbar">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        <img src="<?php echo e(asset('assets/imgs/main4.png')); ?>" class="brand-img" alt="">
    ...
    <header>
        ...
        <div class="carousel-item active">
            <img src="<?php echo e(asset('assets/imgs/main.jpg')); ?>" class="d-block w-100 carousel-img" alt="Image 1">
            <div class="carousel-caption animated fadeInDown d-none d-md-block">
                <h5 class="animated-text">Sucursal 1</h5>
            </div>
        </div>
        <div class="carousel-item">
            <img src="<?php echo e(asset('assets/imgs/i2.jpg')); ?>" class="d-block w-100 carousel-img" alt="Image 2">
            <div class="carousel-caption animated fadeInUp d-none d-md-block">
                <h5 class="animated-text">Sucursal 2</h5>
            </div>
        </div>
        <div class="carousel-item">
            <img src="<?php echo e(asset('assets/imgs/i7.jpg')); ?>" class="d-block w-100 carousel-img" alt="Image 3">
        ...
        <div class="carousel-item"> <!-- Nueva imagen -->
            <img src="<?php echo e(asset('assets/imgs/i8.jpg')); ?>" class="d-block w-100 carousel-img" alt="Image 4">
...
<script src="<?php echo e(asset('assets/vendors/bootstrap/bootstrap.affix.js')); ?>"></script>
<script src="<?php echo e(asset('assets/vendors/wow/wow.js')); ?>"></script>
<!-- Google Maps -->
<script async defer src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCtme10pzgKSPeJVJrG1O3tjR6lk98o4w8&callback=initMap"></script>
<!-- FoodHut js -->
<script src="<?php echo e(asset('assets/js/foodhut.js')); ?>"></script>
    <script>
...
<?php /**PATH /home/u919984931/domains/importadoramiranda.com/resources/views/vista/index.blade.php ENDPATH**/ ?>