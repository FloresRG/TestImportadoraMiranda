...
<?php $__env->startSection('title', 'Productos en Mal Estado'); ?>
        ...
        <div class="row mb-3">
            ...
            <div class="col-md-3">
                ...
                <select id="usuario_destino" class="form-control">
                    ...
                    <?php $__currentLoopData = $usuariosorigen; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $usuario): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php $__env->startSection('js'); ?>
    ...
    <script>
        $(document).ready(function() {
            let tabla = $('#productosMalEstadoTable').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: "<?php echo e(route('envios.productosMalEstado')); ?>",
                    data: function(d) {
    ...
    <script>
        $('#generarPDF').on('click', function() {
            ...
            window.open("<?php echo e(route('envios.productosMalEstadoPDF')); ?>" + query, '_blank');
        });
    </script>
...
<?php echo $__env->make('adminlte::page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u919984931/domains/importadoramiranda.com/resources/views/envios/productosMalEstado.blade.php ENDPATH**/ ?>