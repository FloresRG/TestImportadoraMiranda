    ...
    <div class="container-fluid px-4">
        ...
        <div class="row justify-content-center mb-5">
            <div class="col-md-4 mb-3">
                <form action="<?php echo e(route('cajas.abrir_todas')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
            ...
            <div class="col-md-4 mb-3">
                <form action="<?php echo e(route('cajas.cerrar_todas')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
                ...
                <div class="col-sm-6 col-md-4 col-lg-3">
                    <div class="card card-modern text-center shadow-lg border-0 h-100">
                        <div class="card-header bg-primary bg-gradient text-white fw-semibold rounded-top">
                            <i class="fas fa-store-alt me-2"></i> <?php echo e($sucursal->nombre); ?>

                        </div>
                        <div class="card-body d-flex flex-column justify-content-between">
                            <div>
                                <img src="<?php echo e(asset('images/logo_old_2.png')); ?>"
                                     class="rounded-circle shadow-sm mb-3"
                                     width="90" height="90"
                                     alt="Logo sucursal">
                                <p class="text-muted mb-3 small">
                                    <i class="fas fa-map-marker-alt"></i>
                                    <?php echo e($sucursal->direccion ?? 'Ubicación no disponible'); ?>
                            ...
                            <?php if($cajaAbierta): ?>
                                <a href="<?php echo e(route('cajas.index', $sucursal->id)); ?>"
                                   class="btn btn-success w-100 shadow-sm fw-semibold">
                                   <i class="fas fa-eye me-1"></i> Ver Caja
                                </a>
                            <?php else: ?>
                                <a href="<?php echo e(route('cajas.create', $sucursal->id)); ?>"
...
<?php echo $__env->make('adminlte::page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u919984931/domains/importadoramiranda.com/resources/views/cajas/sucursales.blade.php ENDPATH**/ ?>