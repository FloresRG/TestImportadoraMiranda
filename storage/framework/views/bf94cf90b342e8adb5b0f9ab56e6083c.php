                ...
                <div class="col-md-6 form-group">
                    ...
                    <select name="id_cupo" class="form-control">
                        ...
                        <?php $__currentLoopData = $cupos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cupo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($cupo->id); ?>"><?php echo e($cupo->codigo); ?></option>
...
<?php echo $__env->make('adminlte::page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u919984931/domains/importadoramiranda.com/resources/views/productos/create.blade.php ENDPATH**/ ?>