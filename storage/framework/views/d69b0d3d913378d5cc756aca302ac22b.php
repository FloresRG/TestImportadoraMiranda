                    ...
                    <div class="row justify-content-center">
                        <div class="col-md-8">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form id="pedido-form" action="<?php echo e(route('cliente.store')); ?>" method="POST">
                                        <?php echo csrf_field(); ?>
...
<?php /**PATH /home/u919984931/domains/importadoramiranda.com/resources/views/cliente/index.blade.php ENDPATH**/ ?>