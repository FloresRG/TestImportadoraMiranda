...
<?php $__env->startSection('content'); ?>
    <div class="card shadow-lg border-0 rounded">
        ...
        <div class="card-body p-4">
            <form action="<?php echo e(route('envios.producto.update', $historial->id)); ?>" method="POST" id="envio-form">
                <?php echo csrf_field(); ?>
                ...
                <div class="row">
                            ...
                            <select name="id_sucursal" id="id_sucursal" class="form-control" required
                                ...
                                <?php $__currentLoopData = $sucursales; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sucursal): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($sucursal->id); ?>"
                                        <?php echo e($historial->id_sucursal == $sucursal->id ? 'selected' : ''); ?>>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="id_usuario" class="fw-bold text-primary">Usuario Destino</label>
                            <select name="id_usuario" id="id_usuario" class="form-control" required>
                                <option value="" disabled>Selecciona un usuario</option>
                                <?php $__currentLoopData = $usuarios; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $usuario): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($usuario->id); ?>"
                                        <?php echo e($historial->id_user_destino == $usuario->id ? 'selected' : ''); ?>>
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        <select id="nuevo_producto" class="form-control select2">
                            <option value="" disabled selected>Selecciona un producto...</option>
                            <?php $__currentLoopData = $productos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $producto): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($producto->id); ?>" data-stock="<?php echo e($producto->stock); ?>">
                ...
                <div class="table-responsive">
                    <table class="table table-striped table-hover">
                        ...
                        <tbody id="lista-productos">
                            <?php $__currentLoopData = $historial->productos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $producto): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr data-id="<?php echo e($producto->id_producto); ?>"
                                    data-cantidad-antes="<?php echo e($producto->cantidad_antes); ?>">
                                    ...
                                    <td>
                                        ...
                                        <input type="hidden" name="productos[<?php echo e($producto->id_producto); ?>][cantidad]"
...
<?php $__env->startSection('js'); ?>
    ...
    `);
            ...
            $(document).on('click', '.eliminar-producto', function() {
                ...
                // Agregar el ID del producto eliminado a un input hidden
                $('#envio-form').append(
...
<?php echo $__env->make('adminlte::page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u919984931/domains/importadoramiranda.com/resources/views/envios/edit.blade.php ENDPATH**/ ?>