        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            <label for="ci"><i class="fa fa-id-card"></i> CI / NIT</label>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            <div class="d-flex align-items-center mb-2">
                                <label for="vendedorSearch" class="mr-3 mb-0"><strong><i class="fa fa-user-circle"></i>
                                        ¿Elegir vendedor?</strong></label>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            <label for="tipo_pago"><i class="fa fa-credit-card"></i> Método de Pago</label>
                            <div class="row">
                                <div class="col-md-4">
                ...
                <div class="row" id="monto-pagado-container">
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="pagado" id="monto-pagado-label"><i class="fa fa-money-bill"></i> Monto
                                Pagado</label>
                            <input type="number" id="pagado" class="form-control"
                                placeholder="Ingrese monto pagado" required>
                        </div>
                    </div>
                    <div class="col-md-6" id="pagos-efectivo-qr" style="display:none;">
                        <div class="form-group">
                            <label for="pagado_qr"><i class="fa fa-qrcode"></i> Monto Pagado por QR</label>
            ...
            <div class="modal-footer d-flex flex-column w-100 gap-3">
                <!-- Bloque de resumen: siempre en la parte superior del footer -->
                <div class="row w-100 g-3">
                    <!-- Descuento -->
                    <div class="col-md-4">
                        <div class="form-group mb-0">
                            <div class="d-flex align-items-center mb-2">
                                <label class="mr-2 mb-0"><strong><i class="fa fa-tag"></i> ¿Aplicar
                                        descuento?</strong></label>
                                <div class="toggle-button-cover-descuento">
                                    <div id="button-descuento" class="button-descuento r">
                                        <input class="checkbox-descuento" type="checkbox" id="descuento_switch"
                                            value="si">
                                        <div class="knobs-descuento"></div>
                                        <div class="layer-descuento"></div>
                                    </div>
                                </div>
                                <input type="hidden" name="aplicar_descuento" id="descuento_hidden" value="no">
                            </div>

                            <div id="descuento-fields" class="mt-2"
                                style="display: none; transition: max-height 0.3s ease;">
                                <div class="row g-2">
                                    <div class="col-6">
                                        <label for="descuento" class="form-label small"><i class="fa fa-tag"></i>
                                            Descuento</label>
                                        <input type="number" name="descuento" id="descuento"
                                            class="form-control form-control-sm" value="0">
                                    </div>
                                    <div class="col-6">
                                        <label for="monto-total" class="form-label small"><i
                                                class="fa fa-receipt"></i> Total sin descuento</label>
                                        <input type="number" id="monto-total" name="monto_total_sin_descuento"
                    ...
                    <div class="col-md-4">
                        <div class="form-group mb-0">
                            <label for="cambio" class="form-label"><i class="fa fa-calculator"></i> Cambio</label>
                    ...
                    <div class="col-md-4">
                        <div class="form-group mb-0">
                            <label for="total-a-pagar" class="form-label"><i class="fa fa-receipt"></i> Monto Total a
                                Pagar</label>
                ...
                <!-- Botones: siempre pegados al fondo del footer, sin moverse -->
                <div class="d-flex flex-wrap justify-content-end gap-2 mt-auto pt-2 border-top w-100">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Cerrar</button>
                    <a href="#" id="vaciar-carrito-fvc" class="btn btn-danger">Vaciar carrito</a>
