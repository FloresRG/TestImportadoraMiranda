...
<?php $__env->startSection('content'); ?>
    <div class="card shadow-lg border-0">
        <div class="card-header bg-primary text-white text-center">
            <h3 class="card-title">
                <i class="fas fa-shipping-fast"></i> Nuevo Envío de Producto a Sucursal 1
            </h3>
        </div>
        <div class="card-body p-4">
            <form action="<?php echo e(route('envios.storeEnvio')); ?>" method="POST" id="envio-form">
                <?php echo csrf_field(); ?>

                <div class="form-group">
                    <label for="id_sucursal" class="font-weight-bold">Sucursal Destino</label>
                    <select name="id_sucursal" id="id_sucursal" class="form-control rounded" required onchange="cargarUsuarios(this.value);">
                        <option value="" disabled selected>Selecciona una sucursal</option>
                        <?php $__currentLoopData = $sucursales; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sucursal): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php if($sucursal->id != 1): ?>
                    ...
                    <div class="input-group">
                        <select id="nuevo_producto" class="form-control select2 buscador">
                            ...
                            <?php $__currentLoopData = $productos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $producto): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                ?>
                                <option value="<?php echo e($producto->id); ?>" data-stock="<?php echo e($stockSucursal1); ?>">
                                    <?php echo e($producto->nombre); ?> (Stock disponible en Sucursal 1: <?php echo e($stockSucursal1); ?>)
                                </option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                ...
                <div class="form-group text-center">
                    <button type="submit" id="enviar-productos" class="btn btn-success px-4">
                        <i class="fas fa-paper-plane"></i> Enviar Productos
                    </button>
                </div>
            </form>
        </div>
...
<?php $__env->startSection('js'); ?>
    <script>
        ...
        $(document).ready(function() {
            ...
            function obtenerStock(idProducto) {
                $.get("<?php echo e(url('/productos')); ?>/" + idProducto + "/stock", function(data) {
    ...
    console.log('Stock disponible:', stock); // Aquí puedes usar esta constante según lo necesites
                ...
                if (productoId && cantidad) {
                    ...
                    $.get("<?php echo e(url('/productos')); ?>/" + productoId + "/stock", function(data) {
                        console.log(data);
            ...
            $('#envio-form').on('submit', function(event) {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        if (response.success) {
                            const pdfData = response.reportUrl.split(',')[1]; // Get base64 part
                            const byteCharacters = atob(pdfData); // Decode base64 string
                            ...
                            window.location.href = response
                                .redirectUrl; // Redirect to index page
                        } else {
...
<?php echo $__env->make('adminlte::page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u919984931/domains/importadoramiranda.com/resources/views/envios/solicitar.blade.php ENDPATH**/ ?>