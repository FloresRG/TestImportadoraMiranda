...
<?php $__env->startSection('content'); ?>
    ...
    <div class="container mt-4">
        <div class="card">
            ...
            <div class="card-body">
                <form action="<?php echo e(route('orden.cuaderno.faltantes.update', $pedido->id)); ?>" method="POST" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
    ...
    <div class="col-md-6" id="campo_qr" style="display: none;">
        ...
        <input type="number" step="0.01" name="transferencia_qr" id="transferencia_qr" class="form-control"
            value="<?php echo e(old('transferencia_qr', $pedido->transferencia_qr ?? 0)); ?>">
                    ...
                    <a href="<?php echo e(route('envios.faltante.view', $pedido->id_semana)); ?>" class="btn btn-secondary"><i
...
<?php echo $__env->make('adminlte::page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u919984931/domains/importadoramiranda.com/resources/views/orden/editPedidocuadernofaltantes.blade.php ENDPATH**/ ?>