        ...
        <tbody>
            <?php $__currentLoopData = $productosDisponibles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $producto): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <tr class="producto-row" data-nombre="<?php echo e(strtolower($producto['nombre'])); ?>">
                    ...
                    <td>
                        <span class="<?php echo e($isStockLow ? 'text-danger' : ''); ?>">
                    ...
                    <td>
                        <?php if($producto['Stock'] > 0): ?>
                            <button class="btn btn-success btn-sm" data-toggle="modal" data-target="#modalAgregarCantidad"
                                    ...
                                    data-stock-restante="<?php echo e($producto['Stock']); ?>">
    ...
    <div class="modal fade" id="modalAgregarCantidad" tabindex="-1" role="dialog" aria-labelledby="modalAgregarLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form id="formAgregarCantidad" action="<?php echo e(route('control.inventario', $id)); ?>" method="POST">
                    <?php echo csrf_field(); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('adminlte::page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u919984931/domains/importadoramiranda.com/resources/views/control/inventario.blade.php ENDPATH**/ ?>