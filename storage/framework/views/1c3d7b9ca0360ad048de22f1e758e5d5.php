...
<body>
    ...
    <div class="container">
        <div class="col-sm-12 text-center">
            <img src="<?php echo e(asset('images/logo.png')); ?>" alt="Logo" class="logo" width="100px">
...
<div class="step" id="step-6">
    <div class="mb-3">
        ...
        <input type="file" class="form-control <?php $__errorArgs = ['foto_comprobante'];
...
unset($__errorArgs, $__bag); ?>" id="foto_comprobante" name="foto_comprobante" accept=".jpg, .jpeg, .png" required onchange="validateFile()">
...
<div class="step" id="step-7">
    ...
    <form method="POST" action="<?php echo e(route('cliente.storenuevo')); ?>" enctype="multipart/form-data" id="finalForm" style="display: none;">
        <?php echo csrf_field(); ?>
    ...
    .then(data => {
        if (data.success) {
            ...
            Swal.fire({
                ...
                setTimeout(() => {
                    Swal.close(); 
                    window.location.href = '<?php echo e(route("nuevo.index")); ?>';// Cierra la alerta después de 5 segundos
...
</html><?php /**PATH /home/u919984931/domains/importadoramiranda.com/resources/views/nuevo/index.blade.php ENDPATH**/ ?>