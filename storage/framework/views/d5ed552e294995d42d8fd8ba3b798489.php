                    ...
                    <div class="sucursal-card">
                        <div class="card-header-custom">
                            <div class="sucursal-image-container">
                                <img src="<?php echo e(asset('images/ol.png')); ?>" alt="Sucursal <?php echo e($sucursal->nombre); ?>"
                        ...
                        <div class="card-body-custom">
                            <h4 class="sucursal-title"><?php echo e($sucursal->nombre); ?></h4>
                            <div class="sucursal-divider"></div>

                            <div class="action-buttons">
                                <a href="<?php echo e(route('carpetas.index', ['sucursal_id' => $sucursal->id])); ?>"
                                ...
                                <a href="<?php echo e(url('/envioscuadernosucursal/' . $sucursal->id)); ?>"
                                ...
                                <a href="<?php echo e(url('/orden/pedidos/' . (156 + $sucursal->id))); ?>" class="btn-orange">
                                    <div class="btn-icon">
                                        <i class="fas fa-book"></i>
                                    </div>
                                    <div class="btn-content">
...
<?php echo $__env->make('adminlte::page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u919984931/domains/importadoramiranda.com/resources/views/carpetas/admin_tarjetas.blade.php ENDPATH**/ ?>