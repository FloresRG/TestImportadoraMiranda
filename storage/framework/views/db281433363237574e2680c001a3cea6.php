    ...
    <div class="container">
        <div class="card-header">
            ...
            <div class="filters mb-4 p-4 shadow bg-light rounded">
                <form action="<?php echo e(route('envios.historial')); ?>" method="GET">
    ...
    <script>
        $(document).ready(function() {
            const table = $('#historialTable').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: "<?php echo e(route('envios.historial')); ?>",
                    data: function(d) {
...
<?php echo $__env->make('adminlte::page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u919984931/domains/importadoramiranda.com/resources/views/envios/historial.blade.php ENDPATH**/ ?>