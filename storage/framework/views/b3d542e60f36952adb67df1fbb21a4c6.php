...
<div class="container">
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            ...
            <form action="<?php echo e(route('report.inventario')); ?>" method="GET" class="form-inline mb-4">
                ...
                <a href="<?php echo e(route('report.inventario.pdf', ['start_date' => request('start_date'), 'end_date' => request('end_date')])); ?>" 
                    ...
                    <tbody>
                        <?php $__currentLoopData = $inventarios; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $inventario): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                               ...
                               <td><?php echo e($inventario->updated_at); ?></td>
                                <td><?php echo e($inventario->producto ? $inventario->producto->nombre : 'No disponible'); ?></td>
                                <td><?php echo e($inventario->sucursale ? $inventario->sucursale->nombre : 'No disponible'); ?></td>
                                <td><?php echo e($inventario->cantidad); ?></td>
                                <td><?php echo e($inventario->user ? $inventario->user->name : 'No disponible'); ?></td>
                            </tr>
...
<?php echo $__env->make('adminlte::page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u919984931/domains/importadoramiranda.com/resources/views/report/inventario.blade.php ENDPATH**/ ?>