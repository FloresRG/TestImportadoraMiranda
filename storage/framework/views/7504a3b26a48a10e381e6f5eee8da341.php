    ...
    <?php $__env->startSection('title', 'Capturas'); ?>
    ...
    <?php $__env->startSection('content_header'); ?>
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <a href="<?php echo e(route('carpetas.index')); ?>" class="btn btn-secondary float-right">
                        ...
                        <form id="fotoForm" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-control" id="carpeta_id" name="carpeta_id" required>
                                    ...
                                    <?php $__currentLoopData = \App\Models\Carpeta::all(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $carpeta): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($carpeta->id); ?>"><?php echo e($carpeta->descripcion); ?></option>
        ...
        <script>
            ...
            $(document).ready(function() {
                ...
                var table = $('#capturasTable').DataTable({
                    processing: true,
                    serverSide: true,
                    ajax: '<?php echo e(route('capturas.index')); ?>',
                    columns: [{
                            data: 'id'
                        },
                        {
                ...
                $('#addFotoBtn').click(function() {
                    ...
                    $('#fotoForm')[0].reset();
                    $('#fotoForm').attr('action', '<?php echo e(route('capturas.store')); ?>');
...
<?php echo $__env->make('adminlte::page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u919984931/domains/importadoramiranda.com/resources/views/capturas/index.blade.php ENDPATH**/ ?>