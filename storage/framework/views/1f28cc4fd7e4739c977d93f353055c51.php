...
<?php $__env->startSection('title', 'Capturas de Carpeta'); ?>
<?php $__env->startSection('content_header'); ?>
    <div class="row mb-2">
        <div class="col-sm-6">
            <h1><?php echo e($carpeta->descripcion); ?></h1>
            <p class="text-muted">
                <i class="fas fa-calendar"></i> <?php echo e(\Carbon\Carbon::parse($carpeta->fecha)->format('d/m/Y')); ?>
...
<?php $__env->startSection('content'); ?>
    <div class="card">
        <div class="card-body">
            ...
            <form action="<?php echo e(route('carpetas.show', $carpeta->id)); ?>" method="GET" class="mb-4" id="realtimeSearchForm">
                    ...
                    <div class="col-md-9">
                        <div class="input-group">
                            ...
                            <input type="text" name="search_captura" id="searchCapturaInput" class="form-control"
                                placeholder="Buscar por nombre..." value="<?php echo e(request('search_captura')); ?>"
                                autocomplete="off">
                ...
                <div class="form-row align-items-center mb-2">
                    ...
                    <div class="col-md-3">
                        <div class="input-group">
                            ...
                            <input type="text" name="search_captura_1" id="searchCapturaInput1" class="form-control"
                                placeholder="Buscar por Nombre..." value="<?php echo e(request('search_captura_1')); ?>"
                                autocomplete="off">
                    ...
                    <div class="col-md-3">
                        <div class="input-group">
                            ...
                            <input type="text" name="search_captura_2" id="searchCapturaInput2" class="form-control"
                                placeholder="Buscar por monto..." value="<?php echo e(request('search_captura_2')); ?>"
                                autocomplete="off">
                    ...
                    <div class="col-md-3">
                        <div class="input-group">
                            ...
                            <input type="text" name="search_captura_3" id="searchCapturaInput3" class="form-control"
                                placeholder="Buscar Fecha..." value="<?php echo e(request('search_captura_3')); ?>" autocomplete="off">
                    ...
                    <div class="col-md-3 d-flex">
                        <a href="<?php echo e(route('carpetas.show', $carpeta->id)); ?>" class="btn btn-danger w-100">
            ...
            <div class="modal-content">
                ...
                <form action="<?php echo e(route('capturas.store')); ?>" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="modal-body">
                        <input type="hidden" name="carpeta_id" value="<?php echo e($carpeta->id); ?>">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
                    ...
                    searchTimeouts[inputId] = setTimeout(async () => {
                        try {
                            const response = await fetch(
                                `<?php echo e(route('carpetas.search_suggestions', $carpeta->id)); ?>?query=${encodeURIComponent(query)}`
                            );
            ...
            function triggerRealtimeSearch() {
                ...
                realtimeSearchTimeout = setTimeout(async () => {
                    ...
                    try {
                        ...
                        const response = await fetch(
                            `<?php echo e(route('carpetas.search_realtime', $carpeta->id)); ?>?${params.toString()}`
                        );
            ...
            async function sendOcrResultsToServer(results, successMessage) {
                ...
                try {
                    const response = await fetch('<?php echo e(route('carpetas.process_all_ocr', $carpeta->id)); ?>', {
                        method: 'POST',
                        headers: {
            ...
            const initialCaptures = [
                <?php $__currentLoopData = $capturas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $captura): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    {
                        id: <?php echo e($captura->id); ?>,
                        foto_original_url: "<?php echo e(asset('storage/' . $captura->foto_original)); ?>",
                        campo_texto_exists: <?php echo e(!empty($captura->campo_texto) ? 'true' : 'false'); ?>,
                    },
...
<?php echo $__env->make('adminlte::page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u919984931/domains/importadoramiranda.com/resources/views/carpetas/show.blade.php ENDPATH**/ ?>