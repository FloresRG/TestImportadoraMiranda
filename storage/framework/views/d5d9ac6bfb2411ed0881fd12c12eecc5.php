...
<div class="content-header-modern animated-header d-flex justify-content-between align-items-center flex-wrap">
    <div class="d-flex align-items-center flex-wrap">
        <div class="logo-container">
            <img src="<?php echo e(asset('images/logo.png')); ?>" alt="Logo" class="header-logo simple-rotating-logo">
        </div>
        <div class="ml-3">
    ...
    <div class="section-row">
        <div class="star-performer-section">
            <div class="star-card star-seller-card improved-star-card">
                ...
                <?php if($vendedorTopHoy): ?>
                <div class="star-content">
                    <div class="seller-avatar improved-avatar">
                        <i class="fas fa-user-tie"></i>
                    </div>
                    <h4 class="seller-name"><?php echo e($vendedorTopHoy->user->name); ?></h4>
                    <div class="seller-stats">
                        <span class="sales-count improved-number" data-target="<?php echo e($vendedorTopHoy->total_ventas); ?>">0</span>
    ...
    <div class="section-row">
        <div class="star-performer-section">
            <div class="star-card star-branch-card improved-star-card">
                ...
                <?php if($ventasPorSucursal->first()): ?>
                <div class="star-content">
                    <div class="branch-avatar improved-avatar">
                        <i class="fas fa-store"></i>
                    </div>
                    <h4 class="branch-name"><?php echo e($ventasPorSucursal->first()->sucursal->nombre ?? 'Sucursal Principal'); ?></h4>
                    <div class="branch-stats">
                        <span class="sales-count improved-number" data-target="<?php echo e($ventasPorSucursal->first()->total_ventas); ?>">0</span>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    new Chart(branchesCtx, {
        type: 'bar',
        data: {
            labels: <?php echo json_encode($labelsSucursal, 15, 512) ?>,
            datasets: [{
                label: 'Ventas por Sucursal',
                data: <?php echo json_encode($dataSucursal, 15, 512) ?>,
...
<?php endif; ?>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('adminlte::page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u919984931/domains/importadoramiranda.com/resources/views/home.blade.php ENDPATH**/ ?>