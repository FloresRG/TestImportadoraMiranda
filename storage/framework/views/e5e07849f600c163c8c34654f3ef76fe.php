...
<?php $__env->startSection('content'); ?>
    ...
    <div class="container-fluid">
        ...
        <form method="POST" action="<?php echo e(route('envios.storecuadernosucursal')); ?>" id="create-envio-form" class="needs-validation">
            <?php echo csrf_field(); ?>
...
<?php $__env->startSection('adminlte_js'); ?>
        ...
        $(document).ready(function() {
            ...
            $(document).on('click', '.confirm-pedido', function(e) {
                ...
                if (confirm('¿Estás seguro de confirmar este pedido?')) {
                    ...
                    $.ajax({
                        url: '/pedidos/' + pedidoId + '/confirmsucursal',
                        type: 'POST',
                        data: {
            ...
            $(document).on('click', '.return-pedido', function(e) {
                ...
                if (confirm('¿Estás seguro de devolver este pedido al inventario?')) {
                    ...
                    $.ajax({
                        url: '/pedidos/' + pedidoId + '/devolversucursal',
                        type: 'POST',
                        data: {
                            _token: $('meta[name="csrf-token"]').attr('content')
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            var table = $('#envios-table').DataTable({
                ...
                stateSave: true,
                ajax: {
                    url: "<?php echo e(route('envios.datasucursal')); ?>",
                    data: function(d) {
    ...
    `;
                            ...
                            buttonHTML += `
    ${row.id_pedido ? 
        `<a href="/orden/cuaderno/editsucursal/${row.id}/${row.id_pedido}" class="btn btn-light btn-sm" style="color: #007bff; border-color: #007bff; background-color: #f0f8ff;">
...
<?php echo $__env->make('adminlte::page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u919984931/domains/importadoramiranda.com/resources/views/envioscuaderno/indexsucursal.blade.php ENDPATH**/ ?>