...
<?php $__env->startSection('title', 'Agenda Jefa'); ?>
        ...
        $(document).ready(function() {
            ...
            $('#guardarNota').click(function() {
                ...
                if (titulo && contenido && fecha && color) {
                    ...
                    $.ajax({
                        url: '<?php echo e(route('notasjefa.store')); ?>', // Ruta definida en el archivo de rutas
                        type: 'POST',
                        data: {
                            titulo: titulo,
                            nota: contenido,
            ...
            $('#guardarCambiosNota').click(function() {
                ...
                if (titulo && contenido && fecha && color) {
                    ...
                    $.ajax({
                        url: '<?php echo e(route('notasjefa.update', ':id')); ?>'.replace(':id',
            ...
            $('#eliminarNotaModal').click(function() {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        $.ajax({
                            url: '<?php echo e(route('notasjefa.destroy', ':id')); ?>'.replace(':id',
...
<?php echo $__env->make('adminlte::page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u919984931/domains/importadoramiranda.com/resources/views/notasjefa/index.blade.php ENDPATH**/ ?>