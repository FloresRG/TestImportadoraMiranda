    ...
    <div class="container">
        <div class="card-header">
            ...
            <div class="filters mb-4 p-4 shadow bg-light rounded">
                <form action="<?php echo e(route('envios.solicitud')); ?>" method="GET">
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <input type="date" class="form-control" name="fecha_inicio" id="fecha_inicio"
                                value="<?php echo e(request()->input('fecha_inicio')); ?>">
                        </div>
                        <div class="form-group col-md-4">
                            <label for="fecha_fin">Fecha Fin</label>
                            <input type="date" class="form-control" name="fecha_fin" id="fecha_fin"
                                value="<?php echo e(request()->input('fecha_fin')); ?>">
                        </div>
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <select name="usuario_destino" id="usuario_destino" class="form-control">
                                ...
                                <?php $__currentLoopData = $usuariosDestino; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $usuario): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option
                                        value="<?php echo e($usuario->id); ?>"<?php echo e(request()->input('usuario_destino') == $usuario->id ? 'selected' : ''); ?>>
            ...
            <div class="text-center mb-4">
                <div class="d-flex justify-content-center gap-3">
                    ...
                    <a href="<?php echo e(route('envios.create')); ?>" class="btn btn-success btn-lg">
    ...
    <script>
        $(document).ready(function() {
            const table = $('#solicitudesTable').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: "<?php echo e(route('envios.solicitud')); ?>",
                    data: function(d) {
...
<?php echo $__env->make('adminlte::page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u919984931/domains/importadoramiranda.com/resources/views/envios/solicitud.blade.php ENDPATH**/ ?>