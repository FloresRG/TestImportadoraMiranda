...
<?php $__env->startSection('title', 'Ventas Canceladas'); ?>
                ...
                <div class="row mb-3">
                    <div class="col-md-4">
                        <div class="small-box bg-info">
                            <div class="inner">
                                <h3><?php echo e($totalProductosPerdidos); ?></h3>
                    ...
                    <div class="col-md-4">
                        <div class="small-box bg-warning">
                            <div class="inner">
                                <h1><?php echo e($productoMasCancelado ? $productoMasCancelado->producto->nombre : 'N/A'); ?></h1>
    ...
    <script>
        $(document).ready(function() {
            ...
            const table = $('#canceled-sales-table').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: '<?php echo e(route('ventas.canceladas')); ?>',
                    data: function(d) {
            ...
            $(document).ready(function() {
                $('#export-button').click(function(e) {
                    ...
                    const url = '<?php echo e(route('ventas.canceladas.export')); ?>' + '?' + queryString;
...
<?php echo $__env->make('adminlte::page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u919984931/domains/importadoramiranda.com/resources/views/sales/canceled_sales.blade.php ENDPATH**/ ?>