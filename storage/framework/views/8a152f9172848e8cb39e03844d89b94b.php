...
<?php $__env->startSection('title', 'Editar Reporte de Caja'); ?>
...
<?php $__env->startSection('content'); ?>
    <div class="container mt-5">
        <div class="card shadow-sm border-light rounded">
            ...
            <div class="card-body">
                <form action="<?php echo e(route('caja_sucursal.update', $fechaSucursal->id)); ?>" method="POST">
                    <?php echo csrf_field(); ?>
                    <?php echo method_field('PUT'); ?> <!-- Usamos el método PUT para actualizar -->
                    ...
                    <div class="form-group" hidden>
                        ...
                        <input type="datetime-local" id="fecha_inicio" name="fecha_inicio" class="form-control"
                            value="<?php echo e(old('fecha_inicio', \Carbon\Carbon::parse($fechaSucursal->fecha_inicio)->format('Y-m-d\TH:i'))); ?>">
                    </div>
                    ...
                    <div class="form-group" hidden>
                        ...
                        <input type="datetime-local" id="fecha_fin" name="fecha_fin" class="form-control"
                            value="<?php echo e(old('fecha_fin', \Carbon\Carbon::parse($fechaSucursal->fecha_fin)->format('Y-m-d\TH:i'))); ?>">
                    </div>

                    <!-- Mostrar las fechas seleccionadas como texto -->
                    <div class="alert alert-info">
                        <strong>Fecha Inicio:</strong>
                        <?php echo e(\Carbon\Carbon::parse($fechaSucursal->fecha_inicio)->format('d/m/Y H:i')); ?> <br>
                        <strong>Fecha Fin:</strong>
                        <?php echo e(\Carbon\Carbon::parse($fechaSucursal->fecha_fin)->format('d/m/Y H:i')); ?>
                    ...
                    <div class="form-group">
                        ...
                        <textarea id="detalle" name="detalle" class="form-control" rows="3"><?php echo e(old('detalle', $fechaSucursal->detalle)); ?></textarea>
                    </div>

                    <h3 class="mt-4 font-weight-bold">Sucursales y Totales:</h3>
                        ...
                        <tbody>
                            <?php $__currentLoopData = $sucursales; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sucursal): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <td><?php echo e(number_format($totalesPorSucursal[$sucursal->id]['total_vendido'] ?? 0, 2)); ?>

                                    </td>
                                    <td><?php echo e(number_format($totalesPorSucursal[$sucursal->id]['total_qr'] ?? 0, 2)); ?></td>
                                    <td><?php echo e(number_format($totalesPorSucursal[$sucursal->id]['total_efectivo'] ?? 0, 2)); ?>

                                    </td>
                                    <td>
                                        <input type="text" name="sucursales[<?php echo e($sucursal->id); ?>][qr_oficial]"
                                            class="form-control form-control-sm only-numbers-with-decimal"
                                            value="<?php echo e(old('sucursales.' . $sucursal->id . '.qr_oficial', $cajasSucursales[$sucursal->id]->qr_oficial ?? 0)); ?>">
                                    </td>
                                    <td>
                                        <input type="text" name="sucursales[<?php echo e($sucursal->id); ?>][efectivo_oficial]"
                                            class="form-control form-control-sm only-numbers-with-decimal"
                                            value="<?php echo e(old('sucursales.' . $sucursal->id . '.efectivo_oficial', $cajasSucursales[$sucursal->id]->efectivo_oficial ?? 0)); ?>">
                                    </td>
                                    <input type="hidden" name="sucursales[<?php echo e($sucursal->id); ?>][total_vendido]"
                                        value="<?php echo e($totalesPorSucursal[$sucursal->id]['total_vendido'] ?? 0); ?>">
                                    <input type="hidden" name="sucursales[<?php echo e($sucursal->id); ?>][total_qr]"
                                        value="<?php echo e($totalesPorSucursal[$sucursal->id]['total_qr'] ?? 0); ?>">
                                    <input type="hidden" name="sucursales[<?php echo e($sucursal->id); ?>][total_efectivo]"
                                        value="<?php echo e($totalesPorSucursal[$sucursal->id]['total_efectivo'] ?? 0); ?>">
                                </tr>
                            ...
                            <tr class="table-secondary">
                                ...
                                <td>-</td>
                                <td><?php echo e(number_format($totalDepositoPedidos, 2)); ?></td>
                                <td>-</td>
                                <td>
                                    <input type="text" name="sucursales[PEDIDOS][qr_oficial]"
                                        class="form-control form-control-sm only-numbers-with-decimal"
                                        value="<?php echo e(old('sucursales.PEDIDOS.qr_oficial', $pedidoQrOficial)); ?>"
                                        autocomplete="off">
                                </td>
                                <td>
                                    <input type="text" name="sucursales[PEDIDOS][efectivo_oficial]"
                                        class="form-control form-control-sm only-numbers-with-decimal"
                                        value="<?php echo e(old('sucursales.PEDIDOS.efectivo_oficial', $pedidoEfectivoOficial)); ?>"
                                        autocomplete="off">
                                </td>
                                <input type="hidden" name="sucursales[PEDIDOS][total_vendido]" value="0">
                                <input type="hidden" name="sucursales[PEDIDOS][total_qr]"
                                    value="<?php echo e($totalDepositoPedidos); ?>">
...
<?php echo $__env->make('adminlte::page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u919984931/domains/importadoramiranda.com/resources/views/caja_sucursal/edit.blade.php ENDPATH**/ ?>