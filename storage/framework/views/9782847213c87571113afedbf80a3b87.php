...
<?php $__env->startSection('title', 'Pedidos por Semana'); ?>
    ...
    <div class="container-fluid mt-4">
        ...
        <div class="row">
            <div class="col-lg-4 col-6">
                <div class="small-box bg-info">
                    <div class="inner">
                        <h3><?php echo e(number_format($totalMontoDeposito, 2)); ?> BS</h3>
            ...
            <div class="col-lg-4 col-6">
                <div class="small-box bg-success">
                    <div class="inner">
                        <h3><?php echo e(number_format($totalMontoEnviado, 2)); ?> BS</h3>
            ...
            <div class="col-lg-4 col-6">
                <div class="small-box bg-warning">
                    <div class="inner">
                        <h3><?php echo e(number_format($totalDiferencia, 2)); ?> BS</h3>
        ...
        <div class="card">
            <div class="card-header">
                <h2 class="card-title">Pedidos de <?php echo e($semana->nombre); ?></h2>
                <div class="card-tools d-flex flex-wrap justify-content-between">
                    ...
                    <div class="btn-group mb-2">
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('orden.create')): ?>
                            <a href="<?php echo e(route('orden.create', $id)); ?>" class="btn btn-primary btn-sm me-2">
                                <i class="fas fa-plus"></i> Crear Pedido
                            </a>
                        <?php endif; ?>
                        <a href="<?php echo e(route('orden.pdf', $id)); ?>" class="btn btn-success btn-sm me-2">
                            <i class="fas fa-file-pdf"></i> BCP
                        </a>
                        <a href="<?php echo e(route('orden.pdf.generate', $id)); ?>" class="btn btn-info btn-sm">
                    ...
                    <table id="data_table" class="table table-striped">
                        ...
                        <tbody id="tableBody">
                            <?php $__empty_1 = true; $__currentLoopData = $pedidos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pedido): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr id="<?php echo e($pedido->id); ?>">
                                    <td><input type="checkbox" class="pedido-checkbox" name="pedidos[]"
                                            value="<?php echo e($pedido->id); ?>" data-estado="<?php echo e($pedido->estado); ?>"
                                            data-estado-pedido="<?php echo e($pedido->estado_pedido); ?>">
                                    </td>
                                    <td><?php echo e($pedido->id); ?></td>
                                    <td>
                                        <textarea class="form-control" name="nombre" data-id="<?php echo e($pedido->id); ?>"><?php echo e($pedido->nombre); ?></textarea>
                                    </td>
                                    <td>
                                        <textarea class="form-control" name="ci" data-id="<?php echo e($pedido->id); ?>"><?php echo e($pedido->ci); ?></textarea>
                                    </td>
                                    <td>
                                        <textarea class="form-control" name="celular" data-id="<?php echo e($pedido->id); ?>"><?php echo e($pedido->celular); ?></textarea>
                                    </td>
                                    <td>
                                        <textarea class="form-control" name="destino" data-id="<?php echo e($pedido->id); ?>"><?php echo e($pedido->destino); ?></textarea>
                                    </td>

                                    <td>
                                        <textarea class="form-control" name="direccion" data-id="<?php echo e($pedido->id); ?>"><?php echo e($pedido->direccion); ?></textarea>
                                    </td>
                                    <td>
                                        <textarea class="form-control" name="detalle" data-id="<?php echo e($pedido->id); ?>"><?php echo e($pedido->detalle); ?></textarea>
                                    </td>

                                    <td class="small-text"><?php echo e($pedido->productos); ?></td>

                                    <td><input type="number" class="form-control"
                                            value="<?php echo e($pedido->cantidad_productos); ?>" name="cantidad_productos"
                                            data-id="<?php echo e($pedido->id); ?>"></td>
                                    <td><input type="number" class="form-control"
                                            value="<?php echo e(number_format($pedido->monto_deposito, 2)); ?>" name="monto_deposito"
                                            data-id="<?php echo e($pedido->id); ?>"></td>
                                    <td><input type="text" class="form-control" value="<?php echo e($pedido->codigo); ?>"
                                            name="codigo" data-id="<?php echo e($pedido->id); ?>"></td>
                                    <td>
                                        <span
                                            class="badge 
                                                    <?php if($pedido->estado == 'PAGADO'): ?> bg-success
                                                    <?php elseif($pedido->estado == 'POR COBRAR'): ?>
                                                        bg-warning
                                                    <?php else: ?>
                                    ...
                                    <td>
                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('orden.edit')): ?>
                                            <a href="<?php echo e(route('orden.edit', $pedido->id)); ?>" class="btn btn-light btn-sm"
                                                style="color: #007bff; border-color: #007bff; background-color: #f0f8ff;">
                                                <i class="fas fa-edit"></i>
                                            </a>
                                            <a href="<?php echo e(route('nota.venta', ['pedidoId' => $pedido->id])); ?>"
                                                class="btn btn-primary">
                                                <i class="fa fa-file-invoice" aria-hidden="true"></i>
                                            </a>
                                        <?php endif; ?>

                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('orden.destroy')): ?>
                                            <form action="<?php echo e(route('orden.destroy', $pedido->id)); ?>" method="POST"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="destinoForm">
                        <?php $__currentLoopData = ['Cochabamba', 'Santa Cruz', 'Oruro', 'Sucre', 'Tarija', 'Potosi', 'Trinidad', 'Cobija', 'Provincias', 'Camiri', 'Robore', 'Puerto Suarez', 'Riberalta', 'Rurrenabaque', 'Yacuiba', 'Tupiza', 'Villamontes', 'Bermejo', 'Zona Central', 'El Alto', 'Zona Miraflores', 'Zona Sur', 'Zona Sopocachi']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $destino): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="destinos[]"
                                    value="<?php echo e($destino); ?>" id="<?php echo e($destino); ?>">
                                <label class="form-check-label" for="<?php echo e($destino); ?>">
                                    <?php echo e($destino); ?>
    ...
    <?php $__env->startSection('js'); ?>
        ...
        <script>
            function setPedidoIdNew(id) {
                ...
                addProductFormNew.action = `<?php echo e(route('orden.store-product', '')); ?>/${id}`;
            }
        ...
        <script>
            document.getElementById('generarBcpBtn').addEventListener('click', function() {
                ...
                if (destinosSeleccionados.length > 0) {
                    const idSemana =
                        <?php echo e($id); ?>; // Suponiendo que tienes el ID de la semana disponible en la vista
                    const url =
                        `<?php echo e(route('orden.pdf.nuevo', '')); ?>/${idSemana}?destinos=${destinosSeleccionados.join(',')}`;
            ...
            document.getElementById('generarReporteFichaBtn').addEventListener('click', function() {
                const destinosSeleccionados = getSelectedDestinos();
                if (destinosSeleccionados.length > 0) {
                    const idSemana = <?php echo e($id); ?>;
                    const url =
                        `<?php echo e(route('orden.pdf.generate', '')); ?>/${idSemana}?destinos=${destinosSeleccionados.join(',')}`;
                    window.location.href = url;
                } else {
                    alert('Por favor, selecciona al menos un destino.');
                }
            ...
            document.addEventListener('DOMContentLoaded', function() {
                ...
                if (generarPdfBtn) {
                    generarPdfBtn.addEventListener('click', function() {
                        ...
                        const idSemana = <?php echo e($id); ?>; // Asegúrate de que esta variable esté definida

                        if (selectedPedidos.length > 0) {
                            const url =
                                `<?php echo e(route('orden.pdf.nuevo', '')); ?>/${idSemana}?pedidos=${selectedPedidos.join(',')}`;
                            window.location.href = url;
                        } else {
                        ...
                        if (selectedPedidos.length > 0) {
                            ...
                            Swal.fire({
                                ...
                                if (result.value) {
                                    ...
                                    $.ajax({
                                        url: "<?php echo e(route('orden.confirmarSeleccionados')); ?>", // Ruta que manejará la confirmación en el backend
                                        type: 'PATCH',
                                        data: {
                                        ...
                                        success: function(data) {
                                            if (data.success) {
                                                Swal.fire(
                                                    ...
                                                    const url =
                                                        `<?php echo e(route('orden.pdf.bcResumen', '')); ?>/${idSemana}?pedidos=${selectedPedidos.join(',')}`;
                                                    window.open(url,
            ...
            document.addEventListener('DOMContentLoaded', function() {
                ...
                if (generarPdfBtn) {
                    generarPdfBtn.addEventListener('click', function() {
                        const selectedPedidos = getSelectedPedidos();
                        const idSemana =
                            <?php echo e($id); ?>; // Asegúrate de que esta variable esté definida en tu vista

                        if (selectedPedidos.length > 0) {
                            const url =
                                `<?php echo e(route('orden.pdf.nuevo.generate', '')); ?>/${idSemana}?pedidos=${selectedPedidos.join(',')}`;
                            window.location.href = url;
                        } else {
                            alert('Por favor, selecciona al menos un pedido.');
                        }
                ...
                if (generarNotaVentaBtn) {
                    generarNotaVentaBtn.addEventListener('click', function() {
                        ...
                        if (selectedPedidos.length > 0) {
                            ...
                            const url =
                                `<?php echo e(route('nota.imprimirSeleccionados')); ?>?semana=${idSemana}&pedidos=${selectedPedidos.join(',')}`;
                            window.location.href = url;
                        } else {
                            alert('Por favor, selecciona al menos un pedido.');
                        }
            ...
            $(document).ready(function() {
                $('.confirm-pedido').click(function(event) {
                    ...
                    Swal.fire({
                        ...
                        if (result.value) {
                            $.ajax({
                                url: "<?php echo e(route('orden.confirm', '')); ?>/" + id,
                                type: 'PATCH',
                                data: {
                                    "_token": "<?php echo e(csrf_token()); ?>"
                                },
                    ...
                    cambiarEstadoBtn.addEventListener('click', function() {
                        ...
                        if (selectedPedidos.length > 0) {
                            Swal.fire({
                                ...
                                if (result.value) {
                                    $.ajax({
                                        url: "<?php echo e(route('orden.cambiarEstado')); ?>",
                                        type: 'PATCH',
                                        data: {
                                            "_token": "<?php echo e(csrf_token()); ?>",
                                            "pedidos": selectedPedidos,
                ...
                Array.from(rows).forEach(row => {
                    ...
                    Array.from(inputs).forEach(input => {
                        input.addEventListener('blur', function() {
                            ...
                            $.ajax({
                                url: "<?php echo e(route('orden.updatep', '')); ?>/" + id,
                                type: 'PATCH',
                                data: {
                                    "_token": "<?php echo e(csrf_token()); ?>",
                                    [name]: value
...
<?php echo $__env->make('adminlte::page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u919984931/domains/importadoramiranda.com/resources/views/orden/pedidos.blade.php ENDPATH**/ ?>