        ...
        <table class="table table-striped table-hover table-bordered" id="productosTable"
            ...
            <tbody>
                <?php $__currentLoopData = $productosDisponibles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $producto): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr class="producto-row" data-nombre="<?php echo e(strtolower($producto['nombre'])); ?>">
                        <td><?php echo e($producto['nombre']); ?></td>
                        <td class="text-center">
                            <button class="btn btn-sm toggle-favorite" data-producto-id="<?php echo e($producto['id']); ?>"
                                style="border-radius: 25px; padding: 8px 20px; transition: all 0.3s; min-width: 180px;"
                                data-favorito="<?php echo e($producto['favorito']); ?>">
    ...
    <script>
        $(document).ready(function() {
            ...
            $('.toggle-favorite').on('click', function() {
                ...
                var url = isFavorito ?
                    '/control/sucursal/' + <?php echo e($id); ?> + '/favoritos' :
                    '/control/sucursal/' + <?php echo e($id); ?> + '/favoritos/quitar';
...
<?php echo $__env->make('adminlte::page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u919984931/domains/importadoramiranda.com/resources/views/control/favoritos.blade.php ENDPATH**/ ?>