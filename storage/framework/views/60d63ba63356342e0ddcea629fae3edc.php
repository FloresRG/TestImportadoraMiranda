...
<?php $__env->startSection('title', 'Gestión de Promociones'); ?>
...
<div class="container">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4 flex-wrap gap-3">
        <a href="<?php echo e(route('promociones.create')); ?>" class="btn btn-futuristic">
        ...
        <div class="col">
            <div class="card h-100">
                <div class="card-header">
                    <h5 class="card-title m-0"><?php echo e($promocion->nombre); ?></h5>
                </div>
                <div class="card-body">
                    <p><strong>Precio Promoción:</strong> <span class="badge bg-info text-white">Bs <?php echo e(number_format($promocion->precio_promocion, 2)); ?></span></p>
                    <p><strong>Estado:</strong>
                        <span class="badge <?php echo e($promocion->estado ? 'bg-success' : 'bg-danger'); ?>">
                            <?php echo e($promocion->estado ? 'Activo' : 'Inactivo'); ?>

                        </span>
                    </p>
                    <p><strong>Sucursal:</strong> <?php echo e($promocion->sucursal->nombre ?? 'N/A'); ?></p>
                    <p><strong>Creado por:</strong> <?php echo e($promocion->usuario->name ?? 'N/A'); ?></p>

                    <h6 class="mt-3 mb-2 text-primary">Productos Incluidos:</h6>
                    <ul class="list-group list-group-flush mb-3">
                        <?php $__empty_2 = true; $__currentLoopData = $promocion->productos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $producto): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_2 = false; ?>
                            <?php
                            ...
                            <li class="list-group-item">
                                ...
                                Cantidad: <?php echo e($producto->pivot->cantidad); ?>, Precio Unitario: Bs <?php echo e(number_format($producto->pivot->precio_unitario, 2)); ?><br>
                                <span class="text-muted">Stock en Sucursal (<?php echo e($promocion->sucursal->nombre ?? 'N/A'); ?>): <?php echo e($stockDisponible); ?></span>
                            </li>
                    ...
                    <div class="card-actions">
                        <button class="btn btn-futuristic btn-success open-modal"
                            ...
                            data-id="<?php echo e($promocion->id); ?>"
                            data-precio="<?php echo e($promocion->precio_promocion); ?>"
                            data-sucursal="<?php echo e($promocion->sucursal->id); ?>"
                            data-productos="<?php echo e($promocion->productos->map(function ($producto) {
                                            return [
                                                'id' => $producto->id,
                        ...
                        <a href="<?php echo e(route('promociones.edit', $promocion->id)); ?>"
                            class="btn btn-futuristic btn-warning">
                            <i class="fas fa-edit"></i> Editar
                        </a>
                        <form action="<?php echo e(route('promociones.destroy', $promocion->id)); ?>" method="POST" class="d-inline">
                            <?php echo csrf_field(); ?>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        function confirmarVenta() {
            ...
            fetch('<?php echo e(route('finpromocion')); ?>', {
                    method: 'POST',
                    body: formData,
                    headers: {
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('adminlte::page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u919984931/domains/importadoramiranda.com/resources/views/promociones/index.blade.php ENDPATH**/ ?>