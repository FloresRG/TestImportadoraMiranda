...
<?php $__env->startSection('title', 'Editar Foto'); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <form id="saveForm" action="<?php echo e(route('capturas.update', $captura->id)); ?>" method="POST" style="display:none;">
        <?php echo csrf_field(); ?>
...
<?php $__env->startSection('js'); ?>
    ...
    <script>
        ...
        function loadScaledImage() {
            fabric.Image.fromURL('/storage/<?php echo e($captura->foto_original); ?>', function(img) {
...
<?php echo $__env->make('adminlte::page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u919984931/domains/importadoramiranda.com/resources/views/capturas/edit.blade.php ENDPATH**/ ?>