...
<?php $__env->startSection('title', 'Crear Reporte de Caja'); ?>
...
<?php $__env->startSection('content'); ?>
    <div class="container mt-5">
        <div class="card shadow-sm border-light rounded">
            ...
            <div class="card-body">
                <form action="<?php echo e(route('caja_sucursal.create')); ?>" method="GET" class="mb-4">
                    <?php echo csrf_field(); ?>
                        ...
                        <div class="col-md-5 col-12 mb-3">
                            <div class="form-group">
                                ...
                                <input type="datetime-local" id="fecha_inicio" name="fecha_inicio" class="form-control"
                                    value="<?php echo e(old('fecha_inicio', $fechaInicio)); ?>">
                            </div>
                        </div>
                        <div class="col-md-5 col-12 mb-3">
                            <div class="form-group">
                                ...
                                <input type="datetime-local" id="fecha_fin" name="fecha_fin" class="form-control"
                                    value="<?php echo e(old('fecha_fin', $fechaFin)); ?>">
                            </div>
                        </div>
                ...
                <form action="<?php echo e(route('caja_sucursal.store')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="text" name="sucursales[<?php echo e($sucursal->id); ?>][qr_oficial]"
                                            ...
                                            value="<?php echo e(old('sucursales.' . $sucursal->id . '.qr_oficial', 0)); ?>">
                                    </td>
                                    <td>
                                        <input type="text" name="sucursales[<?php echo e($sucursal->id); ?>][efectivo_oficial]"
                                            class="form-control form-control-sm only-numbers-with-decimal"
                                            value="<?php echo e(old('sucursales.' . $sucursal->id . '.efectivo_oficial', 0)); ?>">
                                    </td>
                            ...
                            <tr class="table-secondary">
                                ...
                                <td>
                                    <input type="text" name="sucursales[PEDIDOS][qr_oficial]"
                                        class="form-control form-control-sm only-numbers-with-decimal"
                                        value="<?php echo e(old('sucursales.PEDIDOS.qr_oficial', 0)); ?>"
                                        autocomplete="off">
                                </td>
                                <td>
                                    <input type="text" name="sucursales[PEDIDOS][efectivo_oficial]"
                                        class="form-control form-control-sm only-numbers-with-decimal"
                                        value="<?php echo e(old('sucursales.PEDIDOS.efectivo_oficial', 0)); ?>"
                                        autocomplete="off">
                                </td>
                    ...
                    <input type="hidden" name="fecha_inicio"
                        value="<?php echo e(\Carbon\Carbon::parse($fechaInicio)->toDateTimeString()); ?>">
                    <input type="hidden" name="fecha_fin"
                        value="<?php echo e(\Carbon\Carbon::parse($fechaFin)->toDateTimeString()); ?>">

                    <!-- Mostrar las fechas seleccionadas -->
                    <div class="alert alert-info mt-4">
                        <strong>Fecha Inicio:</strong> <?php echo e(\Carbon\Carbon::parse($fechaInicio)->format('d/m/Y H:i')); ?> <br>
                        <strong>Fecha Fin:</strong> <?php echo e(\Carbon\Carbon::parse($fechaFin)->format('d/m/Y H:i')); ?>
...
<?php echo $__env->make('adminlte::page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u919984931/domains/importadoramiranda.com/resources/views/caja_sucursal/create.blade.php ENDPATH**/ ?>