    ...
    <script>
        $(document).ready(function() {
            const table = $('#enviosTable').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: "<?php echo e(route('envios.index')); ?>",
                    data: function(d) {
        ...
        function showRevertirModal(envioId, maxCantidad) {
            ...
            form.action = "<?php echo e(url('envios/revertir')); ?>/" + envioId;
...
<?php $__env->startSection('content'); ?>
    <div class="container">
        <div class="card-header">
            ...
            <div class="filters mb-4 p-4 shadow bg-light rounded">
                ...
                <form method="GET" action="<?php echo e(route('envios.index')); ?>" class="form-inline justify-content-center">
                    ...
                    <a href="<?php echo e(route('envios.report', ['fecha_inicio' => request('fecha_inicio'), 'fecha_fin' => request('fecha_fin')])); ?>"
        ...
        <div class="text-center mb-4">
            <a href="<?php echo e(route('envios.solicitar')); ?>" class="btn-custom btn-primary">
                <i class="fas fa-plus-circle"></i> Nuevo Envío de Productos
            </a>

            <a href="<?php echo e(route('envios.transfer')); ?>" class="btn-custom btn-info">
    ...
    <div class="modal fade" id="enviarSucursal1Modal" tabindex="-1" role="dialog"
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <form id="enviarSucursal1Form" method="POST" action="<?php echo e(route('envios.sendSucursal1')); ?>">
                    <?php echo csrf_field(); ?>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <select id="productoSelect" class="form-control mt-2" size="5"
                                ...
                                <?php $__currentLoopData = $productosAlmacen; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $producto): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($producto->id); ?>" data-nombre="<?php echo e($producto->nombre); ?>"
                                        data-stock="<?php echo e($producto->stock); ?>">
                                        <?php echo e($producto->nombre); ?> (Stock: <?php echo e($producto->stock); ?>)
                                    </option>
    ...
    <div class="modal fade" id="revertirModal" tabindex="-1" aria-labelledby="revertirModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <form id="revertirForm" method="POST" action="<?php echo e(route('envios.revertir', 0)); ?>">
                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('adminlte::page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u919984931/domains/importadoramiranda.com/resources/views/envios/index.blade.php ENDPATH**/ ?>