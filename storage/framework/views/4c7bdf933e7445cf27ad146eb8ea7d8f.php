...
<?php $__env->startSection('title', 'Registrar Nuevo Proveedor'); ?>
...
<?php $__env->startSection('content'); ?>
    <div class="card">
        <div class="card-body">
            <form action="<?php echo e(route('proveedores.store')); ?>" method="POST" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" id="codigo_factura" name="codigo_factura" value="<?php echo e(old('codigo_factura')); ?>" required>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="number" class="form-control <?php $__errorArgs = ['deuda_total'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" id="deuda_total" name="deuda_total" value="<?php echo e(old('deuda_total')); ?>" step="0.01" min="0" required>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="number" class="form-control <?php $__errorArgs = ['pago_inicial'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" id="pago_inicial" name="pago_inicial" value="<?php echo e(old('pago_inicial', 0)); ?>" step="0.01" min="0" required>
...
unset($__errorArgs, $__bag); ?>" id="fecha_registro" name="fecha_registro" value="<?php echo e(old('fecha_registro', date('Y-m-d'))); ?>" required>
...
unset($__errorArgs, $__bag); ?>" id="estado" name="estado" required>
                                <option value="Saldo pendiente" <?php echo e(old('estado') == 'Saldo pendiente' ? 'selected' : ''); ?>>Saldo pendiente</option>
                                <option value="Pagado" <?php echo e(old('estado') == 'Pagado' ? 'selected' : ''); ?>>Pagado</option>
                            </select>
...
unset($__errorArgs, $__bag); ?>" id="foto_factura" name="foto_factura" accept="image/jpeg,image/png,image/jpg">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('adminlte::page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u919984931/domains/importadoramiranda.com/resources/views/proveedores/create.blade.php ENDPATH**/ ?>