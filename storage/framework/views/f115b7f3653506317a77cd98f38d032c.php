<?php $__empty_1 = true; $__currentLoopData = $productos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
    <div class="col-md-4 mb-4">
        <div class="position-relative rounded-4 overflow-hidden shadow-sm border"
            ...
            <?php if($item->producto->fotos->isNotEmpty()): ?>
                <div class="w-100 h-100 position-absolute top-0 start-0 opacity-15"
                    style="background-image: url('<?php echo e(asset('storage/' . $item->producto->fotos->first()->foto)); ?>'); background-size: cover; background-position: center; z-index: 0;">
                </div>
            <?php endif; ?>
            ...
            <div class="position-relative z-1 d-flex flex-column justify-content-between h-100 pt-16 px-4 pb-4">
                ...
                <div class="mt-auto">
                    <p class="badge rounded-pill px-4 py-2 mb-3" style="background-color: #bae6fd; color: #0284c7; font-weight: 700; font-size: 1.25rem; width: fit-content;">
                        Bs. <?php echo e(number_format($item->producto->precio, 2, ',', '.')); ?>
                    ...
                    <button 
                        ...
                        @click="$dispatch('agregar-al-carrito', {
                            id: <?php echo e($item->producto->id); ?>,
                            nombre: '<?php echo e(addslashes($item->producto->nombre)); ?>',
                            precio: <?php echo e($item->producto->precio); ?>,
                            stock: <?php echo e($item->cantidad); ?>
                        ...
                        <?php echo e($item->cantidad <= 0 ? 'disabled' : ''); ?>

                    >
                        <?php echo e($item->cantidad > 0 ? 'VENDER' : 'SIN STOCK'); ?>
...
</style><?php /**PATH D:\Trabajo Nexus\TestImportadoraMiranda\resources\views/ventas/partials/productos-list.blade.php ENDPATH**/ ?>