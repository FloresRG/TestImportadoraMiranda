...
<div class="container mt-4">
    ...
    <div class="row" id="semanasContainer">
        <?php $__currentLoopData = $ordered; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $semana): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <div class="col-xl-3 col-lg-4 col-md-6 col-sm-12 mb-4 semana-card" data-nombre="<?php echo e(strtolower($semana->nombre)); ?>" 
             data-fecha="<?php echo e(strtolower($semana->fecha)); ?>">
            <div class="card border-light shadow-lg modern-card" style="border-radius: 15px; background-color: #fdfdfd;">
                <div class="card-body text-center">
                    <h5 class="card-title text-primary" style="font-weight: bold; font-size: 1.2rem;"><?php echo e($semana->nombre); ?></h5>
                    <p class="card-text text-muted" style="font-size: 1rem;"><?php echo e($semana->fecha); ?></p>
                    <a href="<?php echo e(route('orden.pedidos', $semana->id)); ?>" class="btn btn-primary modern-btn" style="border-radius: 25px; padding: 10px 20px; font-size: 1rem;">Ver Pedidos</a>
                </div>
                <div class="card-footer text-muted text-center" style="background-color: #f0f8ff; font-size: 0.9rem; border-radius: 0 0 15px 15px;">
                    Última actualización: <?php echo e($semana->updated_at->format('d M Y')); ?>
...
<?php echo $__env->make('adminlte::page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u919984931/domains/importadoramiranda.com/resources/views/orden/index.blade.php ENDPATH**/ ?>