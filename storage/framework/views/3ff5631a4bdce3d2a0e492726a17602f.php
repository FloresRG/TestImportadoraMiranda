...
<?php $__env->startSection('adminlte_js'); ?>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            var table = $('#envios-table').DataTable({
                ...
                stateSave: true,
                ajax: {
        url: "<?php echo e(route('envios.faltante.data')); ?>",  // ← usa tu método que ya filtra por extra2=1
        type: 'GET',
        data: function(d) {
            // si quieres buscar por celular
            if ($('#celular').val()) {
                d.celular = $('#celular').val();
            }
            // no necesitas d.extra2 aquí, porque tu controlador faltanteData
            // ya hace ->where('extra2',1)
        },
        error: function(xhr) {
    ...
    ${row.id_pedido ? 
        ...
        `<a href="/orden/cuaderno/faltantes/edit/${row.id}/${row.id_pedido}" class="btn btn-light btn-sm" style="color: #007bff; border-color: #007bff; background-color: #f0f8ff;">
...
<?php echo $__env->make('adminlte::page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u919984931/domains/importadoramiranda.com/resources/views/envioscuaderno/faltante.blade.php ENDPATH**/ ?>