...
<div class="container">
    ...
    <form action="<?php echo e(route('promociones.update', $promocion->id)); ?>" method="POST">
        <?php echo csrf_field(); ?>
        <?php echo method_field('PUT'); ?>

        <div class="mb-3">
            <label for="nombre" class="form-label">Nombre</label>
            <input type="text" name="nombre" id="nombre" class="form-control form-futuristic" value="<?php echo e($promocion->nombre); ?>" required>
        </div>
        ...
        <div class="mb-3">
            ...
            <select name="id_sucursal" id="id_sucursal" class="form-control form-futuristic" required>
                <?php $__currentLoopData = $sucursales; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sucursal): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option value="<?php echo e($sucursal->id); ?>" <?php echo e($promocion->id_sucursal == $sucursal->id ? 'selected' : ''); ?>>
        ...
        <div class="mb-3">
            ...
            <datalist id="sugerencias_productos">
                <?php $__currentLoopData = $productos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $producto): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option value="<?php echo e($producto->nombre); ?>" data-id="<?php echo e($producto->id); ?>" data-precio="<?php echo e($producto->precio); ?>">
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </datalist>
        </div>
                ...
                <tbody id="productos_seleccionados">
                    <?php $__currentLoopData = $promocion->productos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $producto): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr id="producto-<?php echo e($producto->id); ?>">
                            ...
                            <td><input type="number" name="productos[<?php echo e($producto->id); ?>][precio]" value="<?php echo e($producto->pivot->precio_unitario); ?>" class="form-control precio" step="0.01"></td>
                            <td><input type="number" name="productos[<?php echo e($producto->id); ?>][cantidad]" value="<?php echo e($producto->pivot->cantidad); ?>" class="form-control cantidad" step="1" min="1"></td>
                            <td><input type="number" name="productos[<?php echo e($producto->id); ?>][total]" value="<?php echo e($producto->pivot->cantidad * $producto->pivot->precio_unitario); ?>" class="form-control total" step="0.01"></td>
                            <td><button type="button" class="btn btn-danger btn-sm eliminar">Eliminar</button></td>
                            <input type="hidden" name="productos[<?php echo e($producto->id); ?>][id]" value="<?php echo e($producto->id); ?>">
                        </tr>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </tbody>
        ...
        <div class="mb-3">
            ...
            <input type="number" step="0.01" name="precio_promocion" id="precio_promocion" class="form-control form-futuristic" value="<?php echo e($promocion->precio_promocion); ?>" readonly>
        </div>

        <div class="mb-3">
            <label for="fecha_inicio" class="form-label">Fecha de Inicio</label>
            <input type="date" name="fecha_inicio" id="fecha_inicio" class="form-control form-futuristic" value="<?php echo e($promocion->fecha_inicio); ?>" required>
        </div>

        <div class="mb-3">
            <label for="fecha_fin" class="form-label">Fecha de Fin</label>
            <input type="date" name="fecha_fin" id="fecha_fin" class="form-control form-futuristic" value="<?php echo e($promocion->fecha_fin); ?>" required>
        </div>

        <div class="form-check">
            <input type="checkbox" name="estado" id="estado" class="form-check-input" <?php echo e($promocion->estado ? 'checked' : ''); ?>>
...
<?php echo $__env->make('adminlte::page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u919984931/domains/importadoramiranda.com/resources/views/promociones/edit.blade.php ENDPATH**/ ?>