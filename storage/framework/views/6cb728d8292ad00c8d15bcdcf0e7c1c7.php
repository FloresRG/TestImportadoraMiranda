...
<?php $__env->startSection('content'); ?>
    ...
    <div class="container mt-4">
        <div class="card">
            ...
            <div class="card-body">
                <form action="<?php echo e(route('orden.cuaderno.lapazconfirmados.update', $pedido->id)); ?>" method="POST" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                    <?php echo method_field('PUT'); ?>
                    <input type="hidden" name="id_semana" value="<?php echo e($pedido->id_semana); ?>">
                    <input type="hidden" name="id_envio" value="<?php echo e($id_envio); ?>">
                    <input type="hidden" name="id_pedido" value="<?php echo e($id_pedido); ?>">
                    <div class="row">
                        <div class="col-md-4">
                            <div class="mb-3">
...
unset($__errorArgs, $__bag); ?>"
                                    id="nombre" name="nombre" value="<?php echo e(old('nombre', $pedido->nombre)); ?>" required>
...
unset($__errorArgs, $__bag); ?>" id="ci"
                                    name="ci" value="<?php echo e(old('ci', $pedido->ci)); ?>" required>
                                <?php $__errorArgs = ['ci'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>"
                                    id="celular" name="celular" value="<?php echo e(old('celular', $pedido->celular)); ?>" required>
...
unset($__errorArgs, $__bag); ?>"
                                    id="destino" name="destino" value="<?php echo e(old('destino', $pedido->destino)); ?>" required>
...
unset($__errorArgs, $__bag); ?>
                                    <div class="form-check">
                                        <input class="form-check-input <?php $__errorArgs = ['estado'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" type="radio"
                                            ...
                                            <?php if(old('estado', $pedido->estado) == 'PAGADO'): ?> checked <?php endif; ?>>
...
unset($__errorArgs, $__bag); ?>" type="radio"
                                            ...
                                            <?php if(old('estado', $pedido->estado) == 'POR COBRAR'): ?> checked <?php endif; ?>>
...
unset($__errorArgs, $__bag); ?>" id="detalle" name="detalle" required><?php echo e(old('detalle', $pedido->detalle)); ?></textarea>
                    ...
                    <div class="row">
                        ...
                        <div id="productosSeleccionados" class="mt-3">
                            ...
                            <ul class="list-group" id="productoList">
                                <?php $__currentLoopData = $pedido->pedidoProductos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $producto): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <li class="list-group-item">
                                        Producto: <?php echo e($producto->producto->nombre); ?> - Cantidad: <?php echo e($producto->cantidad); ?>

                                        -
                                        Precio Total: <?php echo e($producto->precio); ?>

                                        <button type="button" class="btn btn-danger btn-sm float-end"
                                            onclick="eliminarProducto(<?php echo e($loop->index); ?>)">
                                            Eliminar
                                        </button>
                                        <button type="button" class="btn btn-primary btn-sm float-end"
                                            onclick="editarProducto(<?php echo e($loop->index); ?>)">
                                            Editar
                                        </button>
                                    </li>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control <?php $__errorArgs = ['cantidad_productos'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                    ...
                                    value="<?php echo e(old('cantidad_productos', $pedido->cantidad_productos)); ?>" required>
                                <?php $__errorArgs = ['cantidad_productos'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" readonly class="form-control bg-light <?php $__errorArgs = ['monto_deposito'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                    ...
                                    value="<?php echo e(old('monto_deposito', $pedido->monto_deposito)); ?>">

                                <?php $__errorArgs = ['monto_deposito'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="garantia" id="sin_garantia" value="sin garantia"
                                    <?php echo e(old('garantia', $pedido->garantia) == 'sin garantia' ? 'checked' : ''); ?>>
                            ...
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="garantia" id="con_garantia" value="con garantia"
                                    <?php echo e(old('garantia', $pedido->garantia) == 'con garantia' ? 'checked' : ''); ?>>
                                <label class="form-check-label" for="con_garantia">Con garantía</label>
                            </div>
                            <?php $__errorArgs = ['garantia'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="forma_pago_radio" id="pago_efectivo" value="efectivo"
                                    <?php echo e(old('forma_pago_radio', ($pedido->efectivo > 0 && ($pedido->transferencia_qr ?? 0) == 0) ? 'efectivo' : '') == 'efectivo' ? 'checked' : ''); ?>
                            ...
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="forma_pago_radio" id="pago_qr" value="qr"
                                    <?php echo e(old('forma_pago_radio', ($pedido->transferencia_qr > 0 && ($pedido->efectivo ?? 0) == 0) ? 'qr' : '') == 'qr' ? 'checked' : ''); ?>
                            ...
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="forma_pago_radio" id="pago_ambos" value="ambos"
                                    <?php echo e(old('forma_pago_radio', ($pedido->efectivo > 0 && $pedido->transferencia_qr > 0) ? 'ambos' : '') == 'ambos' ? 'checked' : ''); ?>
                    ...
                    <input type="hidden" name="forma_pago" id="forma_pago" value="<?php echo e(old('forma_pago', $pedido->efectivo > 0 && $pedido->transferencia_qr > 0 ? 'ambos' : ($pedido->efectivo > 0 ? 'efectivo' : 'qr'))); ?>">
...
<div class="row mt-3">
    <div class="col-md-6" id="campo_efectivo" style="display: none;">
        ...
        <input type="number" step="0.01" name="efectivo" id="efectivo" class="form-control"
            value="<?php echo e(old('efectivo', $pedido->efectivo ?? 0)); ?>">
    </div>
    ...
    <div class="col-md-6" id="campo_qr" style="display: none;">
        ...
        <input type="number" step="0.01" name="transferencia_qr" id="transferencia_qr" class="form-control"
            value="<?php echo e(old('transferencia_qr', $pedido->transferencia_qr ?? 0)); ?>">
    </div>
</div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <datalist id="sugerencias_productos">
                                            <?php $__currentLoopData = $productos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $producto): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($producto->nombre); ?>" data-id="<?php echo e($producto->id); ?>"
                                                    data-precio="<?php echo e($producto->precio); ?>" data-cantidad="1">
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </datalist>
                                    </div>
                    ...
                    <input type="hidden" id="productos" name="productos"
                        value="<?php echo e(json_encode($pedido->pedidoProductos->map(function ($p) {return ['id_producto' => $p->id_producto, 'nombre' => $p->producto->nombre, 'cantidad' => $p->cantidad, 'precio' => $p->precio];})->toArray())); ?>">
                    <div class="row">
                    ...
                    <a href="<?php echo e(route('envioscuaderno.indexconfirmados', $pedido->id_semana)); ?>" class="btn btn-secondary"><i
...
<?php echo $__env->make('adminlte::page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u919984931/domains/importadoramiranda.com/resources/views/orden/editPedidocuadernolapazconfirmados.blade.php ENDPATH**/ ?>