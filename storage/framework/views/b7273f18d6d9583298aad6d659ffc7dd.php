...
<div class="container-fluid">
    ...
    <div class="card">
        <div class="card-header bg-primary">
            <h3 class="card-title"><i class="fas fa-edit"></i> Editar Venta #<?php echo e($venta->id); ?></h3>
        </div>
        <div class="card-body">
            <div class="row mb-3">
                <div class="col-md-3">
                    <label>Cliente:</label>
                    <p class="font-weight-bold"><?php echo e($venta->nombre_cliente); ?></p>
                </div>
                <div class="col-md-3">
                    <label>CI/NIT:</label>
                    <p class="font-weight-bold"><?php echo e($venta->ci); ?></p>
                </div>
                <div class="col-md-3">
                    <label>Fecha Original:</label>
                    <p class="font-weight-bold"><?php echo e($venta->fecha); ?></p>
                </div>
                <div class="col-md-3">
                    <label>Total Original:</label>
                    <p class="font-weight-bold" id="total-original">Bs. <?php echo e(number_format($venta->costo_total, 2)); ?></p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="card">
        ...
        <div class="card-body">
            <table class="table table-striped" id="productos-actuales">
                ...
                <tbody>
                    <?php $__currentLoopData = $venta->ventaProductos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ventaProducto): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr id="producto-<?php echo e($ventaProducto->id); ?>">
                        <td><?php echo e($ventaProducto->producto->nombre); ?></td>
                        <td><?php echo e($ventaProducto->cantidad); ?></td>
                        <td>Bs. <?php echo e(number_format($ventaProducto->precio_unitario, 2)); ?></td>
                        <td>Bs. <?php echo e(number_format($ventaProducto->cantidad * $ventaProducto->precio_unitario, 2)); ?></td>
                        <td>
                            <button type="button" class="btn btn-warning btn-sm" 
                                    onclick="agregarADevolucion(<?php echo e($ventaProducto->id); ?>, '<?php echo e($ventaProducto->producto->nombre); ?>', <?php echo e($ventaProducto->precio_unitario); ?>, <?php echo e($ventaProducto->cantidad); ?>)">
                                <i class="fas fa-exchange-alt"></i> Cambio del mismo Prod.
                            </button>
                            <button type="button" class="btn btn-danger btn-sm" 
                                    onclick="cancelarProducto(<?php echo e($ventaProducto->id); ?>, '<?php echo e($ventaProducto->producto->nombre); ?>')">
...
function ejecutarCambios() {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            $.ajax({
                url: '<?php echo e(route("cancelarventa.ejecutar-cambios")); ?>',
                type: 'POST',
                data: {
                    _token: '<?php echo e(csrf_token()); ?>',
                    venta_id: '<?php echo e($venta->id); ?>',
...
function guardarCambios() {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            window.location.href = '<?php echo e(route("cancelarventa.index")); ?>';
        }
    });
}
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('adminlte::page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u919984931/domains/importadoramiranda.com/resources/views/cancelarventa/edit.blade.php ENDPATH**/ ?>