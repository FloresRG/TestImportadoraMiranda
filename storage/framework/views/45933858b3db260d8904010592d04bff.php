            ...
            <form id="filters-form" class="mb-3">
                ...
                <div class="form-row align-items-center">
                    ...
                    <div class="col mb-2">
                        ...
                        <select id="filters_select" name="filters" class="col mb-0 hidden-checkbox">
                    ...
                    .then(data => {
                        if (data.success) {
                            ...
                            Swal.fire({
                                ...
                                // table.ajax.reload(); este estaba escomentao
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            var table = $('#envios-table').DataTable({
                ...
                stateSave: true,
                ajax: {
                    url: "<?php echo e(route('envios.dataTableSinLaPazYEnviados')); ?>",
                    data: function(d) {
    ...
    `;
      ...
      `;
                ...
                drawCallback: function(settings) {
                    // Calcula el número total de filas en la tabla
                    var totalRows = settings.json.recordsTotal;

                    // Actualiza el campo con el total de filas
...
<?php echo $__env->make('adminlte::page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u919984931/domains/importadoramiranda.com/resources/views/envioscuaderno/indexenlp.blade.php ENDPATH**/ ?>