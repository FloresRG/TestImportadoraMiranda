                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-md-2">
                            ...
                            <input type="datetime-local" id="start_date" name="start_date"
                                ...
                                value="<?php echo e(request('start_date') ? \Carbon\Carbon::parse(request('start_date'))->format('Y-m-d\TH:i') : ''); ?>">
                        </div>
                        <!-- Fecha Fin -->
                        <div class="col-md-2">
                            ...
                            <input type="datetime-local" id="end_date" name="end_date" class="form-control form-control-sm"
                                value="<?php echo e(request('end_date') ? \Carbon\Carbon::parse(request('end_date'))->format('Y-m-d\TH:i') : ''); ?>">
                        </div>
                        <!-- Sucursal -->
                        <div class="col-md-2">
                            ...
                            <select id="id_user" name="id_user" class="form-control form-control-sm">
                                ...
                                <?php $__currentLoopData = $usuarios; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $usuario): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($usuario->id); ?>"
                                        <?php echo e(request('id_user') == $usuario->id ? 'selected' : ''); ?>>
                        ...
                        <div class="col-md-2">
                            ...
                            <select id="estado" name="estado" class="form-control form-control-sm">
                                <option value="">Todos</option>
                                <option value="NORMAL" <?php echo e(request('estado') == 'NORMAL' ? 'selected' : ''); ?>>NORMAL
                                </option>
                                <option value="RECOJO" <?php echo e(request('estado') == 'RECOJO' ? 'selected' : ''); ?>>RECOJO
                                </option>
                            </select>
                        </div>
                        ...
                        <div class="card shadow-sm border-0 mb-3">
                            ...
                            <div class="card-body py-3 px-4">
                                ...
                                <p class="text-muted mb-1"><strong>Total Ventas:</strong> <span id="ventasDiaTotal"
                                        class="fw-bold"><?php echo e($ventasDia->total_ventas_dia ?? 0); ?> Bs</span></p>
                                <p class="text-muted mb-1"><strong>Número de Ventas:</strong> <span id="ventasDiaNumero"
                                        class="fw-bold"><?php echo e($ventasDia->num_ventas_dia ?? 0); ?></span></p>
                            </div>
                        </div>
                        ...
                        <div class="card shadow-sm border-0">
                            ...
                            <div class="card-body py-3 px-4">
                                ...
                                <p class="text-muted mb-1"><strong>Total Ventas:</strong> <span id="ventasMesTotal"
                                        class="fw-bold"><?php echo e($ventasMes->total_ventas_mes ?? 0); ?> Bs</span></p>
                                <p class="text-muted mb-1"><strong>Número de Ventas:</strong> <span id="ventasMesNumero"
                                        class="fw-bold"><?php echo e($ventasMes->num_ventas_mes ?? 0); ?></span></p>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <script>
            $(document).ready(function() {
                const table = $('#ventas-table').DataTable({
                    ...
                    ajax: {
                        url: "<?php echo e(route('report.ventas')); ?>",
                        data: function(d) {
                ...
                $('#generatePdf').click(function(e) {
                    ...
                    window.open("<?php echo e(route('ventas.pdf')); ?>?" + query, "_blank");
                });
                ...
                $('#filter_day').on('change', function() {
                    ...
                    if (selectedDay) {
                        $.ajax({
                            url: "<?php echo e(route('report.dias')); ?>", // Ruta del reporte del día
                            method: "GET",
                            data: {
                                day: selectedDay,
                            },
                ...
                $('#filter_month').on('change', function() {
                    ...
                    if (selectedMonth) {
                        $.ajax({
                            url: "<?php echo e(route('report.mess')); ?>", // Ruta del reporte del mes
                            method: "GET",
                            data: {
                                month: selectedMonth,
                            },
                ...
                $('#btnDailyReport').on('click', function() {
                    ...
                    if (selectedDay) {
                        window.open("<?php echo e(route('report.pdfdia')); ?>?day=" + selectedDay, "_blank");
                    } else {
                ...
                $('#btnMonthlyReport').on('click', function() {
                    ...
                    if (selectedMonth) {
                        window.open("<?php echo e(route('report.pdfmes')); ?>?month=" + selectedMonth, "_blank");
                    } else {
...
<?php echo $__env->make('adminlte::page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u919984931/domains/importadoramiranda.com/resources/views/report/ventas.blade.php ENDPATH**/ ?>