    ...
    <div class="container">
        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('roles.create')): ?>
            <div class="mb-3 text-right">
                <a href="<?php echo e(route('roles.create')); ?>" class="btn btn-gradient-primary btn-lg">
                                ...
                                <tr class="animated fadeIn">
                                    ...
                                    <td class="text-center">
                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('roles.edit')): ?>
                                            <a href="<?php echo e(route('roles.edit', $role)); ?>" class="btn btn-gradient-success btn-sm"
                                        ...
                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('roles.destroy')): ?>
                                            <form action="<?php echo e(route('roles.destroy', $role)); ?>" method="POST"
                                                style="display:inline;" id="delete-form-<?php echo e($role->id); ?>">
                                                <?php echo csrf_field(); ?>
                                                <?php echo method_field('DELETE'); ?>
                                                <button type="button" class="btn btn-gradient-danger btn-sm"
                                                    onclick="confirmDelete(<?php echo e($role->id); ?>)" title="Eliminar rol"
...
<?php echo $__env->make('adminlte::page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u919984931/domains/importadoramiranda.com/resources/views/roles/index.blade.php ENDPATH**/ ?>