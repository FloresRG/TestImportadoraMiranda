...
<?php $__env->startSection('title', 'Cancelar Ventas de la Última Semana'); ?>
...
<div class="container-fluid">
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <form id="reporte-form" action="<?php echo e(route('cancelarventa.nota')); ?>" method="POST">
                <?php echo csrf_field(); ?>
    ...
    <script>
        $(document).ready(function() {
            ...
            function fetchVentas(page = 1, search = '') {
                $.ajax({
                    url: '<?php echo e(route('cancelarventa.ultimasemana')); ?>',
                    method: 'GET',
                    data: {
                        page: page,
                        search: search,
                        ...
                        ventas.forEach(function(ventaProducto) {
                            html += `
                                <tr>
                                    ...
                                    <td>
                                        <form action="<?php echo e(route('cancelarventa.reportesemana', '')); ?>/${ventaProducto.id}" method="POST">
                                            <?php echo csrf_field(); ?>
                                            <button type="submit" class="btn btn-info btn-sm">
                                                <i class="fas fa-file-alt"></i> Reporte
                                            </button>
                                        </form>
                                        <form action="<?php echo e(route('cancelarventa.revertirsemana', '')); ?>/${ventaProducto.id}" method="POST">
                                            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('adminlte::page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u919984931/domains/importadoramiranda.com/resources/views/cancelarventa/ultimasemana.blade.php ENDPATH**/ ?>