...
<?php $__env->startSection('content_header'); ?>
    ...
    <div class="modern-header d-flex justify-content-between align-items-center flex-wrap">
        <div>
            <h1>Venta de productos de <?php echo e($sucur->nombre); ?></h1>
        </div>
        <div id="clock"></div>
    </div>
...
<?php $__env->startSection('content'); ?>
    ...
    <div id="lista-cursos" class="container">
        ...
        <form id="venta-form" method="POST" action="<?php echo e(route('control.finmoderno')); ?>" target="_blank">
            <?php echo csrf_field(); ?>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body text-center">
                        <img src="<?php echo e(asset('images/QR.jpeg')); ?>" alt="Código QR"
                    ...
                    <div class="col-md-4 ${producto.producto.stock_sucursal <= 0 ? 'out-of-stock-card' : ''}">
                        <div class="product-card">
                            ...
                            <div class="product-header" style="${producto.producto.fotos && producto.producto.fotos.length > 0 ? 
                                `background-image: url('<?php echo e(asset('storage/')); ?>/${producto.producto.fotos[0].foto}'); background-size: cover; background-position: center;` : 
    ...
    <script>
        ...
        listaCarrito.addEventListener('click', function(e) {
            if (e.target.classList.contains('eliminar')) {
                ...
                // Actualizar el carrito en localStorage
                const sucursalId =
                    <?php echo e($id); ?>; // Este es un valor dinámico, asegúrate de que esté definido en el backend
                localStorage.setItem(`carrito-${sucursalId}`, JSON.stringify(carrito));
            }
        });
...
<?php echo $__env->make('adminlte::page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u919984931/domains/importadoramiranda.com/resources/views/control/prov2.blade.php ENDPATH**/ ?>