    ...
    <div class="container">
        ...
        <div class="btn-group" role="group" aria-label="Basic example">
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('productos.create')): ?>
                <a href="<?php echo e(route('productos.create')); ?>" class="btn btn-gradient-primary btn-lg">
            ...
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('reporte.index')): ?>
                <a href="<?php echo e(route('productos.report')); ?>" class="btn btn-gradient-danger btn-lg">
        ...
        <form action="<?php echo e(route('productos.generarReporte')); ?>" method="GET" class="mt-4">
            <div class="form-row">
                    ...
                    },
                    {
                        ...
                        render: function(data, type, row) {
                            ...
                            row.fotos.forEach(function(foto) {
                                fotosHtml +=
                                    `<img src="<?php echo e(asset('storage/')); ?>/${foto.foto}" alt="Foto" class="img-thumbnail" style="width: 50px; margin-right: 5px;" loading="lazy">`;
                            });
                            return fotosHtml;
                        }
                    },
...
<?php echo $__env->make('adminlte::page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u919984931/domains/importadoramiranda.com/resources/views/productos/index.blade.php ENDPATH**/ ?>