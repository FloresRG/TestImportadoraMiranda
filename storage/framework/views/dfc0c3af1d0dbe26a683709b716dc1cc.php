...
<?php $__env->startSection('title', 'Productos Al Almacen'); ?>
...
<?php $__env->startSection('js'); ?>
    <script>
        $(document).ready(function() {
            ...
            let table = $('#productosMalEstadoTable').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: "<?php echo e(route('envios.productosAlmacen')); ?>",
                    data: function(d) {
    ...
    <script>
        $('#generarPDF').on('click', function() {
            ...
            window.open("<?php echo e(route('envios.productosAlmacenPDF')); ?>" + query, '_blank');
        });
    </script>

<?php $__env->stopSection(); ?>

<?php echo $__env->make('adminlte::page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u919984931/domains/importadoramiranda.com/resources/views/envios/productosAlmacen.blade.php ENDPATH**/ ?>