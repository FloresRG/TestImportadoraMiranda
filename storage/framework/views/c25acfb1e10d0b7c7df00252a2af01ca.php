...
<?php $__env->startSection('content'); ?>
    ...
    <div class="container mt-4">
        <div class="card">
            ...
            <div class="card-body">
                <form action="<?php echo e(route('orden.store')); ?>" method="POST" enctype="multipart/form-data"> <!-- Añadir enctype -->
                    <?php echo csrf_field(); ?>
                    <input type="hidden" name="id_semana" value="<?php echo e($id); ?>">
...
unset($__errorArgs, $__bag); ?>" id="ci"
                                    name="ci" value="<?php echo e(old('ci')); ?>" required>
                                <?php $__errorArgs = ['ci'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>"
                                    id="celular" name="celular" value="<?php echo e(old('celular')); ?>" required>
...
unset($__errorArgs, $__bag); ?>"
                                    id="destino" name="destino" value="<?php echo e(old('destino')); ?>" required>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <textarea type="text" class="form-control <?php $__errorArgs = ['direccion'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" id="direccion" name="direccion"
                                    value="<?php echo e(old('direccion')); ?>" required> </textarea>
...
unset($__errorArgs, $__bag); ?>" type="radio"
                                            ...
                                            <?php if(old('estado') == 'PAGADO' || (old('estado') === null && isset($model) && $model->estado == 'PAGADO')): ?> checked <?php endif; ?>>
...
unset($__errorArgs, $__bag); ?>" type="radio"
                                            ...
                                            <?php if(old('estado') == 'POR COBRAR' || (old('estado') === null && isset($model) && $model->estado == 'POR COBRAR')): ?> checked <?php endif; ?>>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="number"
                                        class="form-control <?php $__errorArgs = ['monto_enviado_pagado'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                        ...
                                        value="<?php echo e(old('monto_enviado_pagado', 0)); ?>" required>
                                    <?php $__errorArgs = ['monto_enviado_pagado'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>" id="detalle" name="detalle" required><?php echo e(old('detalle')); ?></textarea>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="number"
                                    class="form-control <?php $__errorArgs = ['cantidad_productos'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                    ...
                                    value="<?php echo e(old('cantidad_productos', 0)); ?>" required>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control <?php $__errorArgs = ['monto_deposito'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                    id="monto_deposito" name="monto_deposito" value="<?php echo e(old('monto_deposito', 0)); ?>"
                                    required>
...
unset($__errorArgs, $__bag); ?>"
                                    id="fecha" name="fecha" value="<?php echo e(old('fecha', date('Y-m-d'))); ?>" required>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="file"
                                    class="form-control <?php $__errorArgs = ['foto_comprobante'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                ...
                                <?php $__errorArgs = ['foto_comprobante'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <button type="submit" class="btn btn-primary" id="submitButton"><i class="fas fa-save"></i>
                        Guardar</button>
                    <a href="<?php echo e(route('orden.index')); ?>" class="btn btn-secondary"><i class="fas fa-times"></i>
                        Cancelar</a>
                </form>
            </div>
        </div>
...
<?php echo $__env->make('adminlte::page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u919984931/domains/importadoramiranda.com/resources/views/orden/create.blade.php ENDPATH**/ ?>